...
} from './components/IndividualsListTab';
import {
...
import {
	GroupCreateTaskItemFormatters,
	GroupCreateTaskTableHeaders,
} from './components/tasks/GroupCreateTasks';
...
} from './components/BenefitsGroupTab';
...
const BENEFIT_PLAN_TABS_LABEL_REF_KEY =
	'socialProtection.BenefitPlansListTabLabel';
const BENEFIT_PLAN_TABS_PANEL_REF_KEY =
	'socialProtection.BenefitPlansListTabPanel';
const { BenefitPlansListTabLabel, BenefitPlansListTabPanel } =
...
const DEFAULT_CONFIG = {
	...
	'core.Router': [
		...
		{
			path: `${ROUTE_INDIVIDUAL}/:individual_uuid?`,
			component: IndividualPage,
		},
		{
			path: `${ROUTE_INDIVIDUAL_FROM_GROUP}/:individual_uuid?`,
			component: IndividualPage,
		},
	...
	'socialProtection.MainMenu': [
		...
		{
			text: (
				<FormattedMessage module={INDIVIDUAL_MODULE_NAME} id='menu.groups' />
			),
			icon: <People />,
			route: `/${ROUTE_GROUPS}`,
	...
	'refs': [
		...
		{
			key: 'individual.actions.clearIndividualExport',
			ref: clearIndividualExport,
		},
		{
			key: 'individual.IndividualHistorySearcher',
			ref: IndividualHistorySearcher,
		},
		...
		{
			key: 'individual.GroupIndividualHistorySearcher',
			ref: GroupIndividualHistorySearcher,
		},
		{
			key: 'individual.AdvancedCriteriaRowValue',
			ref: AdvancedCriteriaRowValue,
		},
	...
	'tasksManagement.tasks': [
		...
		},
		{
			text: (
				<FormattedMessage
					module={INDIVIDUAL_MODULE_NAME}
					id='groupIndividual.tasks.update.title'
				/>
			),
		...
		},
		{
			text: (
				<FormattedMessage
					module={INDIVIDUAL_MODULE_NAME}
					id='validation_import_group_valid_items.tasks.title'
				/>
			),
