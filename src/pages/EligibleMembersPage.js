...
import EligibleMembersSearcher from '../components/EligibleMembersSearcher';

const styles = (theme) => ({
  page: theme.page,
});

function EligibleMembersPage(props) {
      ...
      <div className={classes.page}>
        <Helmet
          title={formatMessage(
            ...
            'eligibleMembers.pageTitle',
          )}
        />
        <EligibleMembersSearcher rights={rights} />
      </div>
    )
  );
}
...
export default withModulesManager(
  injectIntl(withTheme(withStyles(styles)(connect(mapStateToProps)(EligibleMembersPage)))),
);
