...
function GroupPage({
	...
	const [isAddIndividualToGroupModalOpen, setIsAddIndividualToGroupModalOpen] =
		useState(false);
			...
			<div className={readOnly ? classes.lockedPage : classes.page}>
				...
				<Form
					...
					saveTooltip={formatMessage(
						intl,
						'individual',
						`saveButton.tooltip.${canSave ? 'enabled' : 'disabled'}`
					)}
