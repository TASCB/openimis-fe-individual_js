...
function GroupsPage(props) {
	const { intl, classes, modulesManager, history, rights } = props;

	const onAdd = () => historyPush(modulesManager, history, GROUP_ROUTE_GROUP);
...
export default withModulesManager(
	injectIntl(
		withTheme(withStyles(styles)(connect(mapStateToProps)(GroupsPage)))
	)
);
